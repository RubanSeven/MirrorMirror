...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title_label.setFixedSize(26, 26)
        ...
        self.title_menu_bar = QMenuBar()
        layout.addWidget(self.title_menu_bar)
        ...
        self.minimum_button.setFixedSize(26, 26)
        self.maximum_button.setFixedSize(26, 26)
        ...
        #minimumButton:hover,#maximumButton:hover,#closeButton:hover {
    ...
    def get_title_menu_bar(self):
        return self.title_menu_bar
...
class FrameLessWindow(QWidget):
    ...
    def showMaximized(self):
        self.title.maximum_button.setText('2')
    ...
    def get_title_menu_bar(self):
        return self.title.get_title_menu_bar()
